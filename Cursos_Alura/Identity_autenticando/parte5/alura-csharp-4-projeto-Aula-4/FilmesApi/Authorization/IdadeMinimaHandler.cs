...
{
    public class IdadeMinimaHandler : AuthorizationHandler<IdadeMinimaRequiredment>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, IdadeMinimaRequiredment requirement)
        {
