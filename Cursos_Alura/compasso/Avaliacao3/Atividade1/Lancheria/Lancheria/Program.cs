...
namespace Lancheria
{
    internal class Program
    {
        ...
        private static void Pedido()
        {
            ...
            MostraCardapioERealizaPedidos();
            Console.Write("Pressione uma tecla para continuar...");
            Console.ReadKey();

        }

        private static int PegaMesa()
        {
        ...
        private static int PegaCodigoProduto()
        {
        ...
        static void MostraCardapioERealizaPedidos()
        {
            Console.WriteLine(
            @"- Entrada em loop :
