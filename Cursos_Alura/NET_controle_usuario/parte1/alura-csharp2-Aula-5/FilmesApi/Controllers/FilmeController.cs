...
namespace FilmesAPI.Controllers
{
    ...
    public class FilmeController : ControllerBase
    {
        ...
        {
            Result filmeAtualizadoDto = _filmeService.AtualizaFilme(id, filmeDto);
            if(filmeAtualizadoDto.IsFailed) return NotFound();
            return NoContent();
        }
        ...
        {
            Result filmeDeletado = _filmeService.DeletaFilme(id);
            if (filmeDeletado.IsFailed)
                return NotFound();
            return NoContent();
        }
